...
**当前状态（2026-09-20）**：威胁模型**初稿已建立**——`docs/design/threat-model/`，共 **13 条**
（`T-01`~`T-13`）。状态分布：**已缓解并验证 1 条 / 部分缓解 10 条 / 未缓解 2 条**。
其中**首条「已缓解并验证」= `T-02`**（2026-09-20 所有者裁决，依据见 `docs/design/threat-model/README.md` §8.2 的 `P-2`）。
