...
> **14 条威胁条目**——**已缓解并验证 1 条 / 部分缓解 11 条 / 未缓解 2 条**
...
| 部分缓解 | **11** | T-01、**T-03**、T-05、T-06、T-07、T-08、T-09、**T-11**、**T-12**、T-13、**T-14**（2026-09-25 新增） |
| 未缓解 | **2** | T-04、T-10 |
| **合计** | **14** | |
...
**按此定义计数：14 条中 7 条缺行为层验证。**（**2026-09-20 重算**：由 8 降为 6——
