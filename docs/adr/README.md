...
| [0021](0021-example-domain-packs-and-first-usable-release.md) | 示例领域包目录（`examples/packs/`）：以**产品正规通路**闭合"非交互 + 未配 pack ⇒ 零工具可执行"的**可用性缺口**（**不改任何安全默认**，只声明只读工具）；并登记 `0.1.0`「首个可用版本」的台账判据与**两条限定**（≠ `M1` 完成、≠ 安全已到位） | **提议中**（2026-09-20，待所有者批准） |
