...
| [0023](0023-ci-downgrade-to-manual-trigger.md) | CI 从「全自动跑测」降级为「人工触发 + 环境内自动化」：停用全部跑测流水线（含 `crontab`）、门禁降为单核 + 路径过滤、跑测改 `make bench`；**四道可信闸门从 CI 的结构迁移到脚本的检查**（部分修订 0014 §2.2/§2.3 与 0016 §5.2 的 E 类） | **已接受**（2026-09-24） |
